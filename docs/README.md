...
- [CAM 作业面交互设计](cam-job-interaction-design.md)：编程交付作业面（件头 / 四阶段 / 当前序 / 冻结与例外 / 交班）；场景包与壳的席位切分；第一张桌子是铣削新件。线框：[cam-job-interaction-wireframes.html](cam-job-interaction-wireframes.html)
