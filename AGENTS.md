...
tool-cam/           CAM 加工插件（`camind-tool-cam`，设计稿 docs/cam-machining-design.md）：
                    ...
                    submit+poll 长任务纪律 + fs 上传/列举/stat + ensureReady/windowsPath）
                    ...
                    + tools/pre-execute 高风险声明硬闸门（只拦 cam_run）
