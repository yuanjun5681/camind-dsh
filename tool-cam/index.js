...
// cam_run/cam_deliver、tools/pre-execute 闸门、断点续跑、2D 图纸
// 解析属后续迭代（设计稿 §4）。
...
export function apply(ctx, config) {
  ...
  console.log('[tool-cam] loaded；registered: camPipeline 服务（connectionInfo/ping/call/run/uploadFile/listDir/stat）、settings namespace cam-nx、工具 cam_survey, cam_plan')
}
